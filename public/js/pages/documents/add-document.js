...
//     // Select2
//     // --------------------------
//     // Exclude the header's project/year selects: header.js already
//     // initializes those with their own AJAX-backed Select2 config.
//     // Re-initializing them here (with no options) runs first and
//     // permanently blocks header.js's config from ever applying,
//     // leaving the header project dropdown showing only the
//     // currently-selected project instead of the full list.
//     $('.select2').not('#selectHeaderProject, #selectHeaderYear').select2();
...
//         $('#createFolderBtn')
//         .toggleClass('disabled', !projectSelected)
//         .css({
//             'pointer-events': projectSelected ? 'auto' : 'none',
//             'opacity': projectSelected ? '1' : '0.5'
//         });
